...
using Don.SportsStoreCore.Web.Models.Account;
using Don.SportsStoreCore.Authorization.Users;
using Don.SportsStoreCore.Controllers;
using Don.SportsStoreCore.Identity;
using Don.SportsStoreCore.Sessions;
using Don.SportsStoreCore.Web.Views.Shared.Components.TenantChange;
using Microsoft.AspNetCore.Identity;

namespace Don.SportsStoreCore.Web.Controllers
{
    public class AccountController : SportsStoreCoreControllerBase
    {
