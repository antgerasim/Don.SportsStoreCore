...
using Don.SportsStoreCore.Authentication.JwtBearer;
using Don.SportsStoreCore.Authorization;
using Don.SportsStoreCore.Authorization.Users;
using Don.SportsStoreCore.Models.TokenAuth;
...
namespace Don.SportsStoreCore.Controllers
{
    ...
    public class TokenAuthController : SportsStoreCoreControllerBase
    {
